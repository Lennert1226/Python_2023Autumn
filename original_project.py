...
# row=1
bannerimg = Image.open("class_6/img/image.webp")
bannerimg = bannerimg.resize((852,298))
...
# row=2
shoe1img = Image.open("class_6/img/2d484182-8596-4d88-aa63-3d594d010d4a.webp")
...
shoe2img = Image.open("class_6/img/5883a335-2363-480b-b3e1-9e083311c247.webp")
...
shoe3img = Image.open("class_6/img/1fdaff44-67e1-4513-a10a-e8e78696e354.webp")
...
shoe4img = Image.open("class_6/img/9f68d99d-756c-4691-af9a-f02eaca628f3.webp")
...
shoppingimg = Image.open("class_6/img/Shopping Cart.png")
